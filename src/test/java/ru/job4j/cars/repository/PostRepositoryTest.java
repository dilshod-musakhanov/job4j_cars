...
public class PostRepositoryTest {
    ...
    @Test
    public void clean() {
        System.out.println("this is clean test");
    }
    ...
    public void whenFindAllThenGetList() {
        ...
        assertThat(result, is(List.of(testPost, testPost2)));
    }
    ...
    public void whenFindByCreatedInThreeLastDays() {
        ...
        file2.setPost(testPost2);
        fileRepository.save(file2);
        assertThat(postRepository.findByCreatedInThreeLastDays(), is(List.of(testPost2)));
    }
    ...
    public void whenFindWithPhotosThenGetList() {
        ...
        assertThat(result, is(List.of(testPost)));
    }
